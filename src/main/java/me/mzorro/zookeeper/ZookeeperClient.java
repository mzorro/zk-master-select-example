...
public class ZookeeperClient {
    ...
    public ZookeeperClient(String localIP, String masterIP, String zkAddress) {
                ...
                if (newState == ConnectionState.CONNECTED || newState == ConnectionState.RECONNECTED) {
                    ...
                    try {
                        ...
                        client.create().withMode(CreateMode.EPHEMERAL_SEQUENTIAL)
                                ...
                                .forPath(childPrefixPath, localIP.getBytes());
                        // 获取最先注册完成的主机IP
            ...
            public void childEvent(CuratorFramework client, PathChildrenCacheEvent event) throws Exception {
                if (event.getType() == PathChildrenCacheEvent.Type.CHILD_REMOVED) {
                    ...
                    if (firstRegisteredIp.equals(localIP)) {
                        ...
                        // TODO: 尝试解除宕机节点对master ip的绑定, 并绑定master ip到当前节点
                    }
                }
            }
        });
    ...
    public String getFirstRegisteredIp() {
        try {
            ...
            return new String(client.getData().forPath(children.get(0)));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
